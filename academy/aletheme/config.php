...
function aletheme_get_options() {
    ...
    $options[] = array( "name" => "Mobile Number",
                        "desc" => "Insert the number phone",
                        "id" => "ale_mobilenumber",
                        "std" => "+7 (499) 375-45-55",
                        "type" => "text");

    $options[] = array( "name" => "Mail",
                        "desc" => "Insert the mail",
                        "id" => "ale_mail",
                        "std" => "a-zdorovienogi@mail.ru",
                        "type" => "text");

    $options[] = array( "name" => "Schedule",
                        "desc" => "Insert a schedule of work",
                        "id" => "ale_schedule-work",
                        "std" => "9:00 — 20:00 Пн. — Пт. с 10:00 — 17:00 Суббота. Воскресенье выходной.",
                        "type" => "text");
